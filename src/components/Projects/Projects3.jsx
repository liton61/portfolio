                    ...
                    {projects.map((project, index) => (
                        <div key={index} className="flex flex-col md:flex-row items-center gap-8">
                            <div className="w-full md:w-1/2">
                                ...
                                >
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/tgTZsQQj/03.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/rpf0q0RB/02.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/fLFV0GK5/03.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/6pdCxp0K/04.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/63B0mvJF/05.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/BbHxgTMr/06.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/PxBWY3zb/07.png" />
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <img className="h-80 border-2 border-green-400 rounded" src="https://i.postimg.cc/L4Yv5fBB/08.png" />
                                    </SwiperSlide>
                                </Swiper>
                            </div>
